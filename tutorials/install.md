...
Создадим специальную директорию для исходных кодов «C:\\Programming\\FreeBASIC Projects». Открой текстовый редактор, например блокнот или Nodepad++, и сохрани текст программы в файле «HelloWorld.bas».
