...
[FreeBASIC-1.07.2-win32-gcc-5.2.0](http://downloads.sourceforge.net/fbc/FreeBASIC-1.07.2-win32.zip?download)
...
[FreeBASIC-1.07.2-win32-gcc-8.1.0](http://downloads.sourceforge.net/fbc/FreeBASIC-1.07.2-win32-gcc-8.1.0.zip?download)
...
[FreeBASIC-1.07.3-win64-gcc-5.2.0](http://downloads.sourceforge.net/fbc/FreeBASIC-1.07.3-win64-gcc-5.2.0.zip?download)

#### FreeBASIC на основе GCC 8.1.0

[FreeBASIC-1.07.3-win64-gcc-8.1.0](http://downloads.sourceforge.net/fbc/FreeBASIC-1.07.3-win64-gcc-8.1.0.zip?download)
...
│       ├───as.exe — ассемблер
│       │
│       ├───dlltool.exe — утилита создания статических библиотек для связи с динамически подключаемыми библиотеками
│       │
...
Оператор `Print` принимает несколько аргументов и выводит их на консоль. Аргументы должны быть разделены запятыми `,` точками с запятой `;` или их сочетанием:
