...
Это даёт подсказку оптимизатору на встраивание функций или удаление таких функций, если на них нет ссылки (удаление мёртвого кода).
...
Если порядок элементов в массиве не важен, то один элемент из массива можно удалить быстро, если затереть его последним:

```FreeBASIC
' Массив из 100 элементов
ReDim Vector(99) As Integer

' Нам нужно удалить 56-ой элемент
' Помещаем последний элемент на место удалённого
Vector(56) = Vector(99)
' Уменьшаем массив
ReDim Preserve Vector(98)
```
