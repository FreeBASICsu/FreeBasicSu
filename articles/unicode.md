...
* при использовании ANSI‐функций WinAPI ты отдаёшь данные в одной кодировке (1251), а функции WinAPI ожидают данные в другой кодировке (866).
...
* перед выводом на экран перекодировать строки «на лету» своей функцией или какой-либо готовой, типа CharToOem.
